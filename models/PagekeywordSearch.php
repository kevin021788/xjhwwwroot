...
/**
 * PagekeywordSearch represents the model behind the search form of `app\models\Pagekeyword`.
 */
class PagekeywordSearch extends Pagekeyword
{
    /**
     * {@inheritdoc}
     */
