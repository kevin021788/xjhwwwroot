...
+function($){
    ...
    var PhotoBrowser = function (params) {
        ...
        var navbarTemplate = pb.params.navbarTemplate ||
                            '<div style="position:absolute;right:0;left:0;top:10px;z-index:10;height:2.2rem;background-color:#00000;">' +
                            '<h1 class="title photo-browser-captions"><div class="center sliding"> <span style="color:white;">' + pb.params.ofText + '</span> </div></h1>' +
                              '<a class="icon pull-right photo-browser-close-link' + (pb.params.type === 'popup' ?  " close-popup" : "") + '"><span style="padding:10px;color:white;">x</span></a>'+
                            '</div>';
        ...
        var captionTemplate = pb.params.captionTemplate || '<div class="photo-browser-caption" data-caption-index="{{captionIndex}}"><span style="font-size:16px;"><span class="photo-browser-current"></span>/<span class="photo-browser-total"></span></span>&nbsp;&nbsp;{{caption}}</div>';
